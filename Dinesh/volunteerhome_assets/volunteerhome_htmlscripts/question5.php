...
<br>
    <input required type="radio" name="question5" value="YES" id="question5" autofocus>YES
    <input required type="radio" name="question5" value="NO" id="question5" autofocus>NO
<br>
<br>
