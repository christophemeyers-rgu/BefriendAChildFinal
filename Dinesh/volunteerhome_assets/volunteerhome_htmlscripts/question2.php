...
<h5>
    <a href="#bar1"><input class="navbuttonprevious"" type="button" id="previous1" name="previous"></a>
    <a href="#bar3"><input class="navbuttonnext" type="button" id="next3" name="next"></a>
</h5>