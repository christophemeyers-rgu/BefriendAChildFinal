...
<br>
    <input required type="radio" name="question6" value="YES" id="question6" autofocus>YES
    <input required type="radio" name="question6" value="NO" id="question6" autofocus>NO
<br>
<br>
